...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file_path' => env('GOOGLE_CLOUD_KEY_FILE', base_path('barbershop-raplontos-2ac6f1948e87.json')), // optional: /path/to/service-account.json
        ...
        'gcs2' => [
            'driver' => 'gcs',
            'key_file_path' => env('GOOGLE_CLOUD_KEY_FILE_PATH', base_path('barbershop-raplontos-2ac6f1948e87.json')),
