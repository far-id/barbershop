    ...
    return (
        <>
            <div>
                ...
                <nav id="sidebarMenu" className="p-0 col-md-4 col-lg-3 d-md-block sidebar collapse">
                    <div className="position-sticky sidebar-sticky d-flex flex-column justify-content-center align-items-center">
                        <ReactScrollLink className="navbar-brand" to="section_1" spy={ true } smooth={ true } offset={ 0 } duration={ 500 }>
                            <img src={ `https://storage.googleapis.com/barbershop-raplontos/images/templatemo-barber-logo.png` } className="logo-image img-fluid" />
                        </ReactScrollLink>
